...
impl Method {
    pub const ALL: &[Method] = &[
        ...
        Method::NativeAddDocuments,
        Method::NativeOpenDocuments,
        Method::OpenExternal,
        Method::Detect,
        Method::Ocr,
        Method::Inpaint,
    ...
    pub fn as_str(self) -> &'static str {
        match self {
            ...
            Method::NativeAddDocuments => "native_add_documents",
            Method::NativeOpenDocuments => "native_open_documents",
...
impl FromStr for Method {
    ...
    fn from_str(s: &str) -> Result<Self, Self::Err> {
        let method = match s {
            ...
            "native_add_documents" => Method::NativeAddDocuments,
            "native_open_documents" => Method::NativeOpenDocuments,
