...
async fn dispatch(method: Method, params: rmpv::Value, state: AppResources) -> Result<rmpv::Value> {
    match method {
        ...
        Method::GetDocumentNames => call0(operations::get_document_names, state).await,
        Method::ClearDocuments => call0(operations::clear_documents, state).await,
        ...
        Method::GetRenderedImage => call(operations::get_rendered_image, state, params).await,
